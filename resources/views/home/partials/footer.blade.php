<footer class="footer-wrapper footer-layout2" data-bg-src="{{ asset('assets/img/bg/footer2-bg.png') }}">
    <div class="container">
        <div class="text-center">
            <div class="footer-top-shape bg-repeat" data-bg-src="{{ asset('assets/img/bg/jiji-bg.png') }}">
            </div>
        </div>
    </div>
                        ...
                        <div class="th-widget-about">
                            <div class="about-logo">
                                <a href="{{ route('home') }}">
                                    ...
                                    <img src="{{ asset('ssets/img/logo.svg') }}" alt="Bame">
                                </a>
                            </div>
                ...
                <div class="col-md-6 col-xl-auto">
                    <div class="widget newsletter-widget footer-widget">
                        ...
                        <form class="newsletter-form">
                            ...
                            <div class="btn-wrap">
                                <a href="#"><img src="{{ asset('assets/img/normal/footer-apple-btn.png') }}" alt="img"></a>
                                <a href="#"><img src="{{ asset('assets/img/normal/footer-playstore-btn.png') }}" alt="img"></a>
                            </div>
                        </form>
                    </div>
                </div>
